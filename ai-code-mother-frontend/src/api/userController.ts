...
export async function getUserById(
  ...
  params: API.BaseResponseUserLoginVO,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseUserLoginVO>('/user/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateUser(body: API.UserUpdateRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>('/user/updateById', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/**  GET /user/get/captcha 获取验证码*/
export async function getCaptcha(email: string) {
  return request<API.BaseResponseUserLoginVO>('/user/get/captcha?email=' + email, {
    method: 'GET',
  })
}
