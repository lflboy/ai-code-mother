...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUploadScreenshot(String webUrl) {
        ...
        try {
            // 上传到本地的逻辑
            /*{
                String imageName = RandomUtil.randomString(16) + ".png";

                String FileName = System.getProperty("user.dir") + File.separatorChar + "file"
                        + File.separatorChar + imageName;
                File file = new File(FileName);
                FileUtil.copy(new File(localScreenshotPath), file, true);
                // 返回响应链接
                return FileConstants.IMAGE_PATH + imageName;
            }*/
            // 上传截图
            return uploadScreenshotToCos(localScreenshotPath);
        } finally {
            // 3. 清理本地文件
