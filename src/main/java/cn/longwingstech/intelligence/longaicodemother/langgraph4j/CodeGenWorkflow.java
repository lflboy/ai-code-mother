package cn.longwingstech.intelligence.longaicodemother.langgraph4j;
...
import cn.longwingstech.intelligence.longaicodemother.langgraph4j.model.QualityResult;
import cn.longwingstech.intelligence.longaicodemother.langgraph4j.node.*;
...
/**
 * 代码生成工作流（实际可用） 目前正式版本依旧采用agent模式，没有采用工作流，这里先实现，后续优化替换
 */
@Slf4j
